/**react-native-dropdown-picker lib*/
...
const img_expandUp = require("../images/survey/up-arrow.png");
const img_expandDown = require("../images/survey/down-arrow.png");
const img_tickMark = require("../images/survey/tick.png");
...
/** Compoenent dropdoqn picker used to show drop down element  
 *  used JS library with referance of react-native-dropdown-picker
*/
class DropDownPicker extends React.Component {
    ...
    /** Method for adding single and multiple items */
    addItem(item) {
    ...
    /** Compoenet render 
     *  replaced item text with dynamic text ui with the HTML render 
     *  using  <HTMLView>
     */
    render() {
        this.props.controller(this);
...
/** Default component propes to set properties value */
DropDownPicker.defaultProps = {
    placeholder: 'Select an item',
    dropDownMaxHeight: height - 330,
    style: {},
    dropDownStyle: {},
    containerStyle: {},
    itemStyle: {},
    ...
    customArrowUp: (size, color) => <Image source={img_expandUp} color={color} />,
    customArrowDown: (size, color) => <Image source={img_expandDown} color={color} />,
    customTickIcon: () => <Image source={img_tickMark} color={color} />,
    zIndex: 5000,
    disabled: false,
    searchable: false,

...
import ImagePanViewer from './image-pan-zoom/image-zoom.component';
...
export default class ImageViewer extends React.Component<Props, State> {
  ...
  public init(nextProps: Props) {
    ...
    Image.getSize(nextProps.imageUrls[0].url, (w, h) => {
        ...
        case 'success':
          ...
          return (
            <View style={{ flex: 1, flexDirection: 'column' }}>
              ...
              <ImagePanViewer
                style={{ backgroundColor: 'transparent', maxWidth: this.width }}
                key={index}
    ...
    return (
      <Animated.View style={{ zIndex: 9 }}>
        <Animated.View
          ...
          {this.props.imageUrls[0] &&
            this.props.imageUrls[0].originSizeKb &&
            this.props.imageUrls[0].originUrl && (
              <View style={this.styles.watchOrigin}>
                <TouchableOpacity
                  style={this.styles.watchOriginTouchable}></TouchableOpacity>
              </View>
            )}
        </Animated.View>
      </Animated.View>

...
class SurveyBox extends Component {
      ...
      if (LastAccess_questionArr.questionArr.length > 0) {
        ...
        this.setState(
          ...
          () => {
            ...
            //this.renderQuestionlayout(allQuestions)
          }
        );
      }
    }
  ...
  // renderQuestionlayout = (questionsArr) => {
  //   horizontalPages = [];
  //   let currentPage = this.state.pageCount > this.state.prevPage ? 1 : 0;
  //   questionsArr && questionsArr.map((queObj, index) => {
  //     let pageCount = index;
  ...
  //           <View
  //             style={{
  //               height: queObj.questionType === "choice" ? this.state.scrollArrow === 'down' ? '95%' : '100%' : '100%',
  //               width: '100%'
  //             }}>
  //             <ScrollView
  //               key={"page-" + pageCount}
  ...
  //               }}
  //               scrollEnabled={
  //                 queObj.questionType === "gps" ? false : (
  //                   queObj.questionType === "scale" ||
  //                     queObj.questionType === "info"
  ...
  //                     {queObj.properties.question_text || queObj.properties.question ? <RenderHtml
  //                       source={{ html: queObj.properties.question_text ? queObj.properties.question_text : queObj.properties.question }}
  //                       contentWidth={width}
  ...
  //                   {(queObj.properties.hasOwnProperty(
  //                     "subheading"
  //                   ) && queObj.properties.subheading.length > 0) && (
  //                       <RenderHtml
  //                         source={{ html: queObj.properties.subheading_text ? queObj.properties.subheading_text : queObj.properties.subheading }}
  //                         contentWidth={width}
  ...
  //                     {/** Info question Type*/}
  //                     {queObj.questionType === "info" &&
  //                       this.layoutInfoTypeQuestion(queObj, pageCount)}

  //                     {/** TextInput question Type*/}
  //                     {queObj.questionType === "input" &&
  ...
  //                     {/** Image question type*/}
  //                     {queObj.questionType === "barcode" &&
  //                       this.layoutScanTypeQuestion(
  //                         queObj,
  //                         pageCount
  //                       )}

  //                     {queObj.questionType === "gps" &&
  ...
  //                     {/** working */}
  //                     {queObj.questionType === "choice" &&
  //                       queObj.properties.display_type === "dropdown" &&
  //                       dropDownArray.map(
  //                         (item, parentIndex) => {
  ...
  //                       queObj.questionType === "choice" &&
  //                       // queObj.properties.display_type === "choice" &&
  //                       queObj.properties.choice_type ===
  //                       "multiple" &&
  //                       queObj.properties.multilevel === 1 &&
  ...
  //                     {queObj.questionType === "choice" &&
  //                       // queObj.properties.display_type === "choice" &&
  //                       queObj.properties.choice_type === "single" &&
  //                       queObj.properties.multilevel === 0 && (
  //                         !queObj.properties.hasOwnProperty('image_size') ||
  //                         queObj.properties.image_size === 'small') &&
  ...
  //                       queObj.properties.multilevel === 0 &&
  //                       queObj.properties.hasOwnProperty('image_size') &&
  //                       queObj.properties.image_size === 'medium' &&
  //                       multiLevelFalseSingleChoiceOuterArray.map(
  //                         (item, parentIndex) => {
  //                           if (item.index === pageCount) {
  ...
  //                       queObj.properties.multilevel === 0 &&
  //                       queObj.properties.hasOwnProperty('image_size') &&
  //                       queObj.properties.image_size === 'large' &&
  //                       multiLevelFalseSingleChoiceOuterArray.map(
  //                         (item, parentIndex) => {
  //                           if (item.index === pageCount) {
  ...
  //                       queObj.questionType === "choice" &&
  //                       // queObj.properties.display_type === "choice" &&
  //                       queObj.properties.choice_type === "multiple" &&
  //                       queObj.properties.multilevel === 0 && (
  //                         !queObj.properties.hasOwnProperty('image_size') ||
  //                         queObj.properties.image_size === 'small') &&
  ...
  //     }
  //     else {
  //       if (this.state.rightDisable && index > this.state.pageCount) {
  //         // skip question
  //       }
  ...
  * */
  ...
  render() {
    ...
    // let loopcount = 0
    // questionsArr && questionsArr.map((queObj, index) => {
    //   console.log('loop Count called', loopcount++)
    //   let pageCount = index;
    //   if (pageCount === this.state.pageCount) {
    //     console.log('Only Count called', onlycount++)
    //     horizontalPages.push(
    //       <View style={{ height: '100%', width: '100%' }} key={"page-" + pageCount}>
    //         <View
    //           style={{
    ...
    //   }
    //   else {
    //     if (rightDisable && index > this.state.pageCount) {
    //       // skip question
    //     }

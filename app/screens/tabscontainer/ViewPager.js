import { PanResponder, Platform, ScrollView, StyleSheet, View } from 'react-native'  //ViewPagerAndroid
...
/** view pager component for tab change paging  */
export default class ViewPager extends Component {
    ...
    /** Page change method for android pager */
    ...
    _childrenWithOverridenStyle() {
        ...
        return React.Children.map(this.props.children, (child) => {
            ...
            if (child.type &&
                ...
                console.log('Each ViewPager child must be a <View>. Was ' + child.type.displayName)
            }
